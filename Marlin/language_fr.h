...
#define MSG_A_RETRACT                       _UxGT("A-rétract")
...
#define MSG_CONTROL_RETRACT                 _UxGT("Rétractation mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Ech. Retr. mm")
#define MSG_CONTROL_RETRACTF                _UxGT("Rétrataction V")
...
#define MSG_INFO_THERMISTOR_MENU            _UxGT("Thermomètres")
